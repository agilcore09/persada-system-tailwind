        ...
        <div class="col-span-10 col-start-2 font-body">
            ...
            <div class="form mt-14">
                <form class="max-w-md mx-auto">
                    ...
                    <button type="submit"
                        class="mt-10 text-white bg-blue-950 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-600 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
                </form>
