...
<div class="hidden md:block relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-full w-full  p-4 shadow-xl shadow-blue-gray-900/5"
    ...
    @can('isAdmin')
        <nav class="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-gray-700">
                ...
                <div class="grid place-items-center mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"
                        ...
                        <path fill-rule="evenodd"
                            d=" M2.25 2.25a.75.75 0 000 1.5H3v10.5a3 3 0 003 3h1.21l-1.172 3.513a.75.75 0
            ...
            <div role="button" tabindex="0"
                class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none  @if (Request::is('kelola-berita/*') || Request::is('kelola-berita')) bg-blue-50 @endif ">
                <div class="grid place-items-center mr-4">
                    <i class="fa-solid fa-newspaper"></i>
                </div><a href="{{ url('/kelola-berita') }}">Kelola Berita</a>
            </div>
            <div role="button" tabindex="0"
                class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none  @if (Request::is('kelola-inventaris/*') || Request::is('kelola-inventaris')) bg-blue-50 @endif ">
                <div class="grid place-items-center mr-4">
                    <i class="fa-solid fa-database"></i>
                </div><a href="{{ url('/kelola-inventaris') }}">Kelola Inventaris</a>
            </div>
            <div role="button" tabindex="0"
                class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none  @if (Request::is('kelola-peminjaman/*') || Request::is('kelola-peminjaman')) bg-blue-50 @endif ">
                <div class="grid place-items-center mr-4">
                    <i class="fa-solid fa-database"></i>
                </div><a href="{{ url('/kelola-peminjaman') }}">Kelola Peminjaman </a>
            </div>
            <div role="button" tabindex="0"
